...
namespace EjemploColegioMVC.Controllers
{
    ...
    public class EstudiantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Apellido,Carnet,TutorId")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Apellido,Carnet,TutorId")] Estudiante estudiante)
        {
            if (ModelState.IsValid)
            {
